...
# Settings parameters #
#######################
DEVtoken = 'DEV-a4f8f255bbd9f01c4dd492bb517f1204fc8edbb0'
...
#####################################
x_train,x_test,y_train,y_test=train_test_split(choosen[cols],choosen[['label']],test_size=0.2,shuffle=True)

############################
# Concert labels into 1/-1 #
############################
